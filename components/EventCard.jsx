...
const EventCard = () => {
  return (
    <div className="bg-gradient-to-b w-[320px] md:skew-y-2 hover:skew-y-0 group ease-linear duration-100 transition-all cursor-pointer rounded-lg from-[#1E1F23] to-[#1E1F23]">
      <img
        src="/harley.png"
        alt="harley "
      ...
      <div className="p-2 w-full flex flex-col gap-2">
        <div className="flex flex-col items-start justify-between">
          <h1 className="text-lg text-wrap wrap text-white-1000 font-bold">
